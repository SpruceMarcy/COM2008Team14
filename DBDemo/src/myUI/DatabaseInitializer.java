...
//				+ ")");	
		...
		stmt.addBatch(
				...
				+ "FOREIGN KEY (workID,submissionID) REFERENCES submission(workID,submissionID) ON DELETE CASCADE"
				+ ")");	
		stmt.addBatch(
				"CREATE TABLE review ("
				+ "reviewerID int NOT NULL,"
		...
		stmt.addBatch(
				...
				+ "PRIMARY KEY (reviewerID,workID,submissionID),"
				+ "FOREIGN KEY (reviewerID,workID,submissionID) REFERENCES review (reviewerID,workID,submissionID) ON DELETE CASCADE"
				+ ")");	
